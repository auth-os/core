...
import '../../test_storage/AbstractStorage.sol';

// RegistryStorage with addtional testing features
contract TestRegistryStorage is TestAbstractStorage {
  ...
  */
  function getAppInitInfo(bytes32 _registry_exec_id, bytes32 _app_provider, bytes32 _app_name) public
  returns (bool, address, bytes32, address, address[]) {
    ...
    assembly {
      ...
      // Read from storage
      let ret := call(gas, target, 0, ptr, 0x84, 0, 0)
