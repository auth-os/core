...
// AppConsole with additional testing features
contract TestAppConsole {
  ...
  function TestAppConsole(address _storage) public {
  ...
  */
  function registerApp(bytes32 _app_name, address _app_storage, bytes _app_desc, bytes _context) public
